...
class RBACService:
    ...
    @staticmethod
    def grant_project_access(db: DBSession, project_id: str, user_id: str, granted_by: str) -> bool:
        """
        ...
        try:
            ...
            access_grant = ProjectAccess(project_id=project_id, user_id=user_id, granted_by=granted_by)
            db.add(access_grant)
            db.commit()
    ...
    @staticmethod
    def revoke_project_access(db: DBSession, project_id: str, user_id: str, revoked_by: str) -> bool:
        """
