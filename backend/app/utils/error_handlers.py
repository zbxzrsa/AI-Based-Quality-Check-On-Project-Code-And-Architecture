...
def with_error_logging(
    error_message: str | None = None, log_level: int = logging.ERROR, include_traceback: bool = True
):
    """
...
def with_performance_logging(threshold_ms: int | None = None, log_level: int = logging.INFO):
    """
            ...
            try:
                ...
                if threshold_ms is None or elapsed_ms >= threshold_ms:
                    logger.log(
                        ...
                        extra={"function": func.__name__, "elapsed_ms": elapsed_ms, "threshold_ms": threshold_ms},
                    )
...
def with_error_transformation(
    error_map: dict[type[Exception], type[Exception]], default_error: type[Exception] | None = None
):
    """
...
def with_validation(validate_args: Callable | None = None, validate_result: Callable | None = None):
    """
...
def with_resilience(
    max_attempts: int = 3, exceptions: tuple[type[Exception], ...] = (Exception,), log_performance: bool = True
):
    """
