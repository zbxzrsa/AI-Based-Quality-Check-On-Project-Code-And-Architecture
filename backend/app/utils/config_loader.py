...
def get_env(key: str, default: str | None = None, required: bool = False, log_value: bool = True) -> str:
    """
...
def get_env_list(key: str, default: list | None = None, separator: str = ",", required: bool = False) -> list[str]:
    """
