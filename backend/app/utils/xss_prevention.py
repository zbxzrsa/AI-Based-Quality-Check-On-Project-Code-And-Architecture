...
ALLOWED_TAGS_BASIC = ["p", "br", "strong", "em", "u", "a", "ul", "ol", "li", "code", "pre"]
...
class XSSProtection:
    ...
    @staticmethod
    def sanitize_html(text: str, level: str = "basic", strip: bool = False) -> str:
        """
        ...
        sanitized = bleach.clean(
            text, tags=allowed_tags, attributes=ALLOWED_ATTRIBUTES, protocols=ALLOWED_PROTOCOLS, strip=True
        )
...
def sanitize_user_input(text: str, context: str = "html", level: str = "basic") -> str:
    """
