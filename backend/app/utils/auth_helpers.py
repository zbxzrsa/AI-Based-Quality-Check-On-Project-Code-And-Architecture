...
def require_self_or_admin(
    current_user: User, target_user_id: str, error_message: str = "You can only access your own data"
) -> None:
    """
...
def require_admin(current_user: User, error_message: str = "Admin privileges required") -> None:
    """
...
def require_active_user(user: User, error_message: str = "User account is not active") -> None:
    """
...
def require_email_confirmed(user: User, error_message: str = "Email must be confirmed to perform this action") -> None:
    """
...
def require_role(current_user: User, allowed_roles: list[str], error_message: str | None = None) -> None:
    """
