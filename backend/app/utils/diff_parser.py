...
class DiffParser:
                    ...
                    current_hunk["changes"].append(
                        {
                            ...
                            + len([c for c in current_hunk["changes"] if c["type"] in ["addition", "context"]]),
                        }
                    )
                    ...
                    current_hunk["changes"].append(
                        {
                            ...
                            + len([c for c in current_hunk["changes"] if c["type"] in ["deletion", "context"]]),
                        }
                    )
    ...
    @staticmethod
    def filter_changes_by_extension(diff_text: str, extensions: list[str]) -> list[dict[str, Any]]:
        """
