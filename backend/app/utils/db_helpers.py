...
async def get_or_404_async(
    db: AsyncSession, model: type[T], id_value: Any, id_field: str = "id", error_message: str | None = None
) -> T:
    """
...
def get_or_404_sync(
    db: Session, model: type[T], id_value: Any, id_field: str = "id", error_message: str | None = None
) -> T:
    """
...
def check_unique_field_sync(
    db: Session, model: type[T], field_name: str, field_value: Any, error_message: str | None = None
) -> None:
    """
...
async def check_unique_field_async(
    db: AsyncSession, model: type[T], field_name: str, field_value: Any, error_message: str | None = None
) -> None:
    """
