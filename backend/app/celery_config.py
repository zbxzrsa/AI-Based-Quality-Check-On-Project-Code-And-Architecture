...
celery_app = Celery(
    "ai_code_review", broker=settings.celery_broker_url_value, backend=settings.celery_result_backend_url
)
...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "app.tasks.ast_parsing.*": {"queue": "default", "routing_key": "default", "priority": 5},
        "app.tasks.graph_building.*": {"queue": "default", "routing_key": "default", "priority": 5},
        "app.tasks.llm_analysis.*": {"queue": "default", "routing_key": "default", "priority": 5},
        ...
        "app.tasks.cleanup.*": {"queue": "low_priority", "routing_key": "low_priority", "priority": 1},
    ...
    beat_schedule={
        ...
        "detect-cycles-daily": {
            ...
            "args": ("*",),
            "options": {"queue": "low_priority", "routing_key": "low_priority", "priority": 2, "expires": 86400},
        },
        ...
        "cleanup-old-analysis-results": {
            ...
            "options": {"queue": "low_priority", "routing_key": "low_priority", "priority": 1, "expires": 86400},
        },
...
def debug_task(self):
    ...
    """
    return {"status": "ok", "task_id": self.request.id, "hostname": self.request.hostname, "worker_pid": os.getpid()}
