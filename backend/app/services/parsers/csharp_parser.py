...
from app.schemas.ast_models import Class, Function, Import, Module, ParsedFile
...
class CSharpParser(BaseASTParser):
    ...
    def _extract_usings(self, code: str) -> list[Import]:
        ...
        for match in re.finditer(using_pattern, code):
            ...
            imports.append(Import(module=namespace, alias=None, is_external=not namespace.startswith(".")))
        ...
        for match in re.finditer(alias_pattern, code):
            ...
            imports.append(Import(module=namespace, alias=alias, is_external=True))
    ...
    def _extract_properties(self, class_body: str) -> list[dict[str, Any]]:
        ...
        for match in re.finditer(prop_pattern, class_body):
            ...
            properties.append({"name": prop_name, "type": prop_type, "is_property": True})
