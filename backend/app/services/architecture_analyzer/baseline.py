...
class BaselineManager:
    ...
    async def create_baseline(
        self, project_id: str, version: str, description: str | None = None
    ...
    async def get_baseline(
        self, project_id: str, version: str | None = None, baseline_id: str | None = None
    ...
    async def _capture_nodes(self, driver: Any, project_id: str) -> list[dict[str, Any]]:
        """
    ...
    async def _capture_relationships(self, driver: Any, project_id: str) -> list[dict[str, Any]]:
        """
    ...
    async def _get_latest_baseline(self, project_id: str) -> ArchitectureBaseline | None:
        """
