...
class CircuitBreaker:
    ...
    def _record_success(self):
        ...
        with self._lock:
            ...
            logger.debug(
                ...
                extra={"circuit_breaker": self.name, "state": self.state.value, "success_count": self.success_count},
            )
    ...
    def _transition_to_half_open(self):
        ...
        logger.info(f"Circuit breaker '{self.name}' transitioned to HALF_OPEN", extra={"circuit_breaker": self.name})
    ...
    def _transition_to_closed(self):
        ...
        logger.info(f"Circuit breaker '{self.name}' transitioned to CLOSED", extra={"circuit_breaker": self.name})
    ...
    def reset(self):
        ...
        with self._lock:
            self._transition_to_closed()
            logger.info(f"Circuit breaker '{self.name}' manually reset", extra={"circuit_breaker": self.name})
