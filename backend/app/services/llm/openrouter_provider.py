...
class OpenRouterProvider(BaseLLMProvider):
    ...
    def __init__(
        ...
        self.client = AsyncOpenAI(
            ...
            base_url=base_url,
            timeout=timeout,
            default_headers={"HTTP-Referer": "https://github.com/ai-code-review", "X-Title": app_name},
        )
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            logger.info(
                ...
                extra={"provider": "openrouter", "model": self.model, "tokens": usage.total_tokens, "cost": cost},
            )
            ...
            logger.error(
                f"OpenRouter API error: {str(e)}", extra={"provider": "openrouter", "model": self.model}, exc_info=True
            )
