    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            logger.info(
                ...
                extra={"provider": "openai", "model": self.model, "tokens": usage.total_tokens, "cost": cost},
            )
            ...
            logger.error(
                f"OpenAI API error: {str(e)}", extra={"provider": "openai", "model": self.model}, exc_info=True
            )
