...
class AnthropicProvider(BaseLLMProvider):
    ...
    def __init__(self, model: str = "claude-3-5-sonnet-20241022", api_key: str | None = None, timeout: int = 30):
        """
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            logger.info(
                ...
                extra={"provider": "anthropic", "model": self.model, "tokens": total_tokens, "cost": cost},
            )
            ...
            logger.error(
                f"Anthropic API error: {str(e)}", extra={"provider": "anthropic", "model": self.model}, exc_info=True
            )
