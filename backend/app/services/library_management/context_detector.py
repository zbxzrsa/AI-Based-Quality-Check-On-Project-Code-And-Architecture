...
class ContextDetector:
    ...
    def detect_context(self, registry_type: RegistryType) -> ProjectContext:
        ...
        logger.info(f"Detected context {context.value} for registry type {registry_type.value}")

        return context

    def validate_context(self, context: ProjectContext) -> tuple[bool, str | None]:
        """
    ...
    def detect_and_validate_context(self, registry_type: RegistryType) -> tuple[ProjectContext, bool, str | None]:
        """
    ...
    def list_available_contexts(self) -> dict:
        ...
        for context in ProjectContext:
            ...
            context_info = {"valid": is_valid, "config_file": config_file}
    ...
    def suggest_alternative_contexts(self, registry_type: RegistryType) -> list[ProjectContext]:
        """
