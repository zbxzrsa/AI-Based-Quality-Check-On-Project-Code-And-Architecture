...
class PerformanceBenchmark:
    ...
    def benchmark(self, func: Callable, iterations: int = 10, warmup: int = 2):
        """
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        summary = {"name": self.name, "total_benchmarks": len(self.results), "benchmarks": self.results}

        return summary

    def compare_with_baseline(self, baseline: dict[str, float], threshold: float = 0.2) -> dict[str, Any]:
        """
        ...
        for result in self.results:
            ...
            if baseline_mean is None:
                comparisons.append(
                    {"function": function_name, "status": "no_baseline", "message": "No baseline value for comparison"}
                )
                continue
