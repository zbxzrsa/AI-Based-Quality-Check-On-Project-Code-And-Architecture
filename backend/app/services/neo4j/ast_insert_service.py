...
class ASTInsertService:
    ...
    async def _insert_module(self, session: AsyncSession, module, project_id: str):
        """Insert module/file node"""
        await session.run(
            """
    ...
    async def _insert_class(self, session: AsyncSession, cls: ClassNode, project_id: str, file_path: str):
    ...
    async def _insert_function(
        self, session: AsyncSession, func: FunctionNode, project_id: str, file_path: str, class_id: str | None
    ):
    ...
    async def _insert_imports(self, session: AsyncSession, module, project_id: str):
        """Insert import dependencies"""
