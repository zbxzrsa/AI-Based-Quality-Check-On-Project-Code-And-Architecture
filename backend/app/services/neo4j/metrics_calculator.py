...
class MetricsCalculator:
    ...
    async def calculate_all_metrics(self, project_id: str) -> dict[str, Any]:
        """
    ...
    async def _get_component_counts(self, session, project_id: str) -> dict[str, int]:
    ...
    async def _get_complexity_metrics(self, session, project_id: str) -> dict[str, Any]:
    ...
    async def _get_coupling_summary(self, session, project_id: str) -> dict[str, Any]:
        ...
        if not data:
            return {"average_instability": 0, "max_instability": 0, "high_instability_count": 0}
    ...
    async def calculate_quality_score(self, project_id: str) -> dict[str, Any]:
        """
        ...
        complexity_score = self._calculate_complexity_score(metrics["complexity_metrics"])
        coupling_score = self._calculate_coupling_score(metrics["coupling_metrics"])
    ...
    def _calculate_complexity_score(self, complexity_metrics: dict[str, Any]) -> float:
    ...
    def _calculate_coupling_score(self, coupling_metrics: dict[str, Any]) -> float:
