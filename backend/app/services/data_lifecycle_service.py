...
class DataLifecycleService:
    ...
    async def cleanup_old_architectural_baselines(
        self, retention_days: int | None = None, dry_run: bool = False, keep_current: bool = True
    ) -> dict[str, Any]:
        """
    ...
    async def cleanup_expired_sessions(
        ...
        try:
            ...
            if not table_exists:
                ...
                return {"status": "skipped", "reason": "sessions_table_not_found", "deleted_count": 0}
    ...
    async def verify_audit_log_retention(self) -> dict[str, Any]:
        ...
        try:
            ...
            verification_result = {
                ...
                "oldest_log_timestamp": oldest_row.oldest_timestamp.isoformat()
                if oldest_row.oldest_timestamp
                else None,
                "oldest_retention_date": oldest_row.oldest_retention.isoformat()
                if oldest_row.oldest_retention
                else None,
            ...
            logger.info(
                f"Audit log retention verification complete: {total_count} logs, oldest from {oldest_row.oldest_timestamp}"
            )
