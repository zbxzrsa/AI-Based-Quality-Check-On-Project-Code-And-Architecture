    ...
    def get_all_characteristics(cls) -> list["ISO25010Characteristic"]:
        ...
        return [
            ...
            cls(
                ...
                sub_characteristics=[
                    ISO25010SubCharacteristic(
                        "Co-existence", "Can perform required functions while sharing environment"
                    ),
            ...
            cls(
                ...
                sub_characteristics=[
                    ...
                    ISO25010SubCharacteristic(
                        "Accessibility", "Can be used by people with widest range of characteristics"
                    ),
                ],
            ),
            cls(
...
class StandardsMapper:
    ...
    def map_to_iso25010(self, finding_category: str) -> ISO25010Characteristic | None:
    ...
    def map_to_iso23396(self, finding_category: str) -> ISO23396Practice | None:
    ...
    def map_to_owasp(self, security_issue: str) -> OWASPVulnerability | None:
