...
class CacheManager:
    ...
    async def connect(self):
        ...
        try:
            ...
            raise CacheException(
                f"Failed to connect to Redis: {str(e)}", operation="connect", error_code="CONNECTION_FAILED"
            )
    ...
    async def set(
        ...
        if not self.client:
            raise CacheException("Cache client not initialized", operation="set", key=key, error_code="NOT_INITIALIZED")
        ...
        try:
            ...
            raise CacheException(f"Failed to set cache: {str(e)}", operation="set", key=key, error_code="SET_FAILED")
    ...
    async def get(self, key: str, deserialize: bool = True) -> Any | None:
        ...
        if not self.client:
            raise CacheException("Cache client not initialized", operation="get", key=key, error_code="NOT_INITIALIZED")
        ...
        try:
            ...
            raise CacheException(f"Failed to get cache: {str(e)}", operation="get", key=key, error_code="GET_FAILED")
    ...
    async def delete(self, key: str) -> bool:
        ...
        if not self.client:
            raise CacheException(
                "Cache client not initialized", operation="delete", key=key, error_code="NOT_INITIALIZED"
            )
        ...
        try:
            ...
            raise CacheException(
                f"Failed to delete cache: {str(e)}", operation="delete", key=key, error_code="DELETE_FAILED"
            )
    ...
    async def exists(self, key: str) -> bool:
        ...
        if not self.client:
            raise CacheException(
                "Cache client not initialized", operation="exists", key=key, error_code="NOT_INITIALIZED"
            )
        ...
        try:
            ...
            raise CacheException(
                f"Failed to check cache existence: {str(e)}", operation="exists", key=key, error_code="EXISTS_FAILED"
            )
    ...
    async def increment(self, key: str, amount: int = 1) -> int:
        ...
        if not self.client:
            raise CacheException(
                "Cache client not initialized", operation="increment", key=key, error_code="NOT_INITIALIZED"
            )
        ...
        try:
            ...
            raise CacheException(
                f"Failed to increment cache: {str(e)}", operation="increment", key=key, error_code="INCREMENT_FAILED"
            )
    ...
    async def expire(self, key: str, seconds: int) -> bool:
        ...
        if not self.client:
            raise CacheException(
                "Cache client not initialized", operation="expire", key=key, error_code="NOT_INITIALIZED"
            )
        ...
        try:
            ...
            raise CacheException(
                f"Failed to set cache expiration: {str(e)}", operation="expire", key=key, error_code="EXPIRE_FAILED"
            )
    ...
    async def get_many(self, keys: list[str], deserialize: bool = True) -> dict[str, Any]:
        ...
        """
        if not self.client:
            raise CacheException("Cache client not initialized", operation="get_many", error_code="NOT_INITIALIZED")
        ...
        try:
            ...
            raise CacheException(
                f"Failed to get multiple cache values: {str(e)}", operation="get_many", error_code="GET_MANY_FAILED"
            )
    ...
    async def delete_pattern(self, pattern: str) -> int:
        ...
        if not self.client:
            raise CacheException(
                "Cache client not initialized", operation="delete_pattern", error_code="NOT_INITIALIZED"
            )
    ...
    async def get_cached_result(self, project_id: str, analysis_type: str) -> Any | None:
