...
class Library(Base):
    ...
    installed_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False, index=True)
    ...
    # Relationships
    dependencies = relationship("LibraryDependency", back_populates="library", cascade="all, delete-orphan")
