...
class ErrorResponse(BaseModel):
    ...
    meta: APIMetadata | None = Field(None, description="Request metadata")
...
def create_success_response(data: Any, message: str | None = None, meta: APIMetadata | None = None) -> APIResponse[Any]:
    """
    ...
    """
    return APIResponse(success=True, data=data, message=message or "Request successful", meta=meta or APIMetadata())
...
def create_error_response(
    ...
    return ErrorResponse(
        error=ErrorDetail(code=error_code, message=message, field=field, details=details), meta=APIMetadata()
    )


def create_paginated_response(
    data: list[Any], page: int, page_size: int, total_items: int, message: str | None = None
    ...
    return PaginatedResponse(
        ...
        meta=APIMetadata(page=page, page_size=page_size, total_items=total_items, total_pages=total_pages),
    )
